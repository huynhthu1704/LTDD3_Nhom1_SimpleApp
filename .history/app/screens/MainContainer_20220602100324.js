...
import {UpdateProfile, ProfileHome, Setting, Favorites} from "./Profile/index"
    ...
    <NavigationContainer>
      ...
      >
        ...
        <HomeStack.Screen
          name="PlayAudio"
          component={PlayAudio}
          options={{ headerTitle: "Profile",  ...headerStyle("transparent")}}
        />
         {/* <ProfileStack.Screen
        name="ProfileHome"
        options={{
      ...
      <HomeStack.Screen
        name="Favorites"
        component={Favorites}
        options={headerStyle(COLORS.pink)}
      />
