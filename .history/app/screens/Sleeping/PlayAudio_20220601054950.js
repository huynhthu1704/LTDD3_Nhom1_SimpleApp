...
export default function PlayAudio({ route }) {
  ...
  function onPlaybackStatusUpdate(playBackStatus) {
    console.log("durationMillis"+layBackStatus.durationMillis);
  ...
  const calculateSeekbar = (playBackDuration, playBackPosition) => {
    if (playBackDuration != null && playBackPosition != null) {
      return Math.floor(playBackPosition / playBackDuration);
    }
    return 0;
  };
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1, justifyContent: "center" }}>
            ...
            <Slider
              ...
              value={calculateSeekbar(playBackDuration, playBackPosition)}
              minimumValue={0}
              maximumValue={1}
              thumbTintColor="red"
