        ...
        <View style={{ flex: 1 }}>
              ...
              <View style={{ marginHorizontal: 30 }}>
                ...
                >
                  <FontAwesome
                    ...
                    name={isPlaying && playBackPosition != playBackDuration ? "pause" : "play"}
                  />
                </TouchableHighlight>
              </View>
              {/* Play, pause button */}
          ...
          <View style={{ flex: 1, justifyContent: "center" }}>
            ...
            <Slider
              ...
              value={Math.floor(playBackPosition/playBackDuration)}
              minimumValue={0}
              thumbTintColor="red"
              ...
              onSlidingComplete={async (value) => {
                ...
                try {
                  const status = await playBackObj.setPositionAsync(value * playBackDuration);
                  setSound(status);
                  setPlayBackPosition(value value * playBackDuration);
