...
import { quad } from "react-native/Libraries/Animated/Easing";
...
// setPlay(true);
      setSound(status);
      setPlayBackObj(obj);
      obj.setOnPlaybackStatusUpdate(this.onPlaybackStatusUpdate);
      return;
      // await obj.playAsync();
    }
            ...
            >
              ...
              >
                <MaterialIcons
                  ...
                  style={{ fontSize: 35, color: COLORS.white, display: !isPlaying ? "none" : "flex", }}
                  name="replay-30"
                />
              </TouchableWithoutFeedback>
