...
export default function PlayAudio({ route }) {
  ...
  function onPlaybackStatusUpdate(playBackStatus) {
    ...
    console.log("positionnMillis1:  " + playBackStatus.positionMillis);
    console.log("playBackStatus.isPlaying:  " + playBackStatus.isPlaying);
                ...
                <TouchableHighlight
                  onPress={async () => {
                    ...
                    if (
                      ...
                      setSound(status);
                      status = await playBackObj.loadAsync(audio.src, { shouldPlay: true }); 
                      setSound(status);
                    }                                                                                                                 
                    setPlay(!isPlaying);
                    playSound();
