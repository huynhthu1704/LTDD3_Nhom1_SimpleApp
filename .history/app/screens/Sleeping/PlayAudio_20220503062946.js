      ...
      >
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style = {{marginVertical : 10, alignItems : 'center'}}>
            ...
            <View style = {{alignItems: 'center',   display: !isPlaying ? "flex" : "none",}}>
            <TouchableWithoutFeedback
            ...
            <View style={{ flexDirection: "row", alignItems: "center",                       display: isPlaying ? "flex" : "none",
 }}>
              <TouchableWithoutFeedback
