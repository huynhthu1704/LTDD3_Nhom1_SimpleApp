  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <HeaderBar color = "white"/>
        ...
        >
          <TouchableOpacity style = {{borderRadius : 10, backgroundColor : COLORS.lightBlue, paddingHorizontal : SIZES.padding, paddingVertical : SIZES.padding/2}}>
            <Text style = {{ color : COLORS.white, ...FONTS.h3}}>Get started</Text>
          </TouchableOpacity>
        </View>
      </ImageBackground>
    </SafeAreaView>
