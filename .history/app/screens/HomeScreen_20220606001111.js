...
import { collection, query, where, getDocs, collectionGroup } from "firebase/firestore/lite";
...
const HomeScreen = ({ navigation }) => {
  ...
  const [recommendAudio, setRecommendAudio] = useState(null);
  ...
  async function getRecommendAudio() {
