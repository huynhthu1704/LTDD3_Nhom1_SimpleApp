...
export function ProfileAvatar() {
  ...
  return (<View style={{backgroundColor: 'red'}}>
   ...
   <View onLayout={(event)=>{find_dimensions(event.nativeEvent.layout)}} style = {{ width : '200%',position: 'absolute', right : 0, bottom: -heightView, backgroundColor: 'green', shadowColor: COLORS.black}}>
