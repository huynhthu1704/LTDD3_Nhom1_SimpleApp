...
(async() => {
  ...
  setHasPermision(status.status === "granted");
})
  }, []);
  return (
    <View>
      <ScrollView>
        <View style={{ justifyContent: "center", alignItems: "center" }}>
          <View style={styles.avatarView}>
            <Image style={styles.avatar} source={image? image : userInfo.avatar} />
            <TouchableOpacity style = {{
              position: "absolute",
              bottom : 20,
              right : 0
            }} onPress={() => {}}><FontAwesome name="camera" size={SIZES.h2}/></TouchableOpacity>
          </View>
