...
export default function HeaderBar({ bgColor, color, name, leftIcon, rightIcon }) {
      ...
      <View style={{ flex: 1, alignSelf: "flex-start" }}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <TouchableOpacity onPress={() => navigation.goBack()}>
            <FontAwesome name={leftIcon} style={{fontStyle : 'italic',fontFamily : "Poppins-MediumItalic"}} size={SIZES.h2} color={color} />
          </TouchableOpacity>
